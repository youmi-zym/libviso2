...
int main (int argc, char** argv) {
    ...
    if (argc<2) {
        ...
        // ./kitti2015 path/to/kitti2015/training/ 200
        // ./kitti2015 path/to/kitti2015/testing/ 200
        cerr << "Usage: ./kitti2015 path/to/sequence/ num_of_image" << endl;
        return 1;
    }
    ...
    for(int imgID=0; imgID < maxID; imgID++)
    {
        ...
        string intrinsic_file = dir + "calib_cam_to_cam/" + intrinsic_file_name;
